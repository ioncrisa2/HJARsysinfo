...
it('blocks sensitive actions without their action permission', function (string $method, string $uri) {
    ...
    ['POST', '/app/backup/artifacts'],
    ['POST', '/app/backup/import'],
    ['GET', '/app/backup/artifacts/unknown/download'],
    ['POST', '/app/backup/artifacts/unknown/verify'],
    ['DELETE', '/app/backup/artifacts/unknown'],
    ['POST', '/app/backup/artifacts/unknown/restore-uploads'],

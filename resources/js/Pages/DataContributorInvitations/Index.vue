...
import DataContributorInviteTable from "../../components/data-contributor/DataContributorInviteTable.vue";
import DataContributorRequestTable from "../../components/data-contributor/DataContributorRequestTable.vue";
import DataContributorRejectDialog from "../../components/data-contributor/DataContributorRejectDialog.vue";
...
const generateInvitation = () => {
    generateForm.post("/app/data-contributor-invitations", {
        preserveScroll: true,
    });
};
...
const acceptRequest = (request) => {
    router.post(`/app/data-contributor-registration-requests/${request.id}/accept`, {}, {
        preserveScroll: true,
    });
};
...
<template>
    <AppLayout title="Data Contributor Invitations">
        <div class="space-y-5">

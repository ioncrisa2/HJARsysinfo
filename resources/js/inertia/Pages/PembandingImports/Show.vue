...
import PembandingImportLayout from "../../Layouts/PembandingImportLayout.vue";

defineOptions({ layout: PembandingImportLayout });
...
const props = defineProps({
    ...
    importContext: { type: Object, required: true },
});
...
const baseUrl = computed(() => props.importContext.base_url);
let pollTimer = null;
...
const patchSelection = (payload) => {
    ...
    router.patch(`${baseUrl.value}/${props.batch.id}/selection`, payload, {
        preserveScroll: true,
...
const applyBulkValue = () => {
    ...
    router.patch(`${baseUrl.value}/${props.batch.id}/bulk-apply`, {
...
const applyFilters = () => {
    router.get(`${baseUrl.value}/${props.batch.id}`, {
...
const finalizeImport = () => {
    ...
    finalizeForm.post(`${baseUrl.value}/${props.batch.id}/finalize`, {
        preserveScroll: true,

...
<body>
    <main class="card">
        ...
        <h1>
            Terjadi <span class="gradient">gangguan server</span>
        </h1>
        <p class="lead">
            Permintaan Anda tidak dapat diproses saat ini karena kesalahan pada server.
        ...
        <p class="footnote">HTTP 500 - Internal Server Error</p>
    </main>
</body>
</html>

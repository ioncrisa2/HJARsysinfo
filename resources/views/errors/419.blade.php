...
<head>
    ...
    <title>{{ config('app.name') }} | Session Expired</title>
...
<body>
    <main class="card">
        ...
        <h1>
            Sesi <span class="gradient">telah berakhir</span>
        </h1>
        <p class="lead">
            Halaman ini kedaluwarsa karena sesi Anda tidak lagi valid.
            Silakan muat ulang halaman dan coba kirim ulang permintaan Anda.
        </p>
        ...
        <p class="footnote">HTTP 419 - Session Expired</p>
    </main>
</body>
</html>

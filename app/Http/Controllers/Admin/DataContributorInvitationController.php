...
class DataContributorInvitationController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return inertia('Admin/DataContributorInvitations/Index', [
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.data-contributor-invitations.index')
    ...
    public function destroy(Request $request, DataContributorInvite $invite): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.data-contributor-invitations.index', ['tab' => 'tokens'])
    ...
    {
        $this->authorizeAdmin('manage_data_contributor_invitations');

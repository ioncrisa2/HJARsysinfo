...
class TopografiResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Topografi';
    ...
    {
        return [
            'index'  => Pages\ListTopografis::route('/'),
            'create' => Pages\CreateTopografi::route('/create'),
            'edit'   => Pages\EditTopografi::route('/{record}/edit'),
        ];
    }
}

...
class BentukTanahResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Bentuk Tanah';
    protected static ?string $pluralModelLabel = 'Bentuk Tanah';
    ...
    {
        return [
            'index'  => Pages\ListBentukTanahs::route('/'),
            'create' => Pages\CreateBentukTanah::route('/create'),
            'edit'   => Pages\EditBentukTanah::route('/{record}/edit'),
        ];
    }
}

...
{
    protected static ?string $model = DokumenTanah::class;
    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static ?string $cluster = MasterData::class;
    protected static ?int $navigationSort = 11;

    protected static ?string $modelLabel = 'Dokumen Tanah';
    ...
    {
        return [
            'index'  => Pages\ListDokumenTanahs::route('/'),
            'create' => Pages\CreateDokumenTanah::route('/create'),
            'edit'   => Pages\EditDokumenTanah::route('/{record}/edit'),
        ];
    }
}

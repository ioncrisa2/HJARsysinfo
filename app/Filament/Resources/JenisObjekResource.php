...
{
    protected static ?string $model = JenisObjek::class;
    protected static ?string $navigationIcon = 'heroicon-o-building-office-2';

    protected static ?string $cluster = MasterData::class;
    protected static ?int $navigationSort = 12;

    protected static ?string $modelLabel = 'Jenis Objek';
    protected static ?string $pluralModelLabel = 'Jenis Objek';
    ...
    {
        return [
            'index'  => Pages\ListJenisObjeks::route('/'),
            'create' => Pages\CreateJenisObjek::route('/create'),
            'edit'   => Pages\EditJenisObjek::route('/{record}/edit'),
        ];
    }
}

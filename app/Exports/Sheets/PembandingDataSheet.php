...
class PembandingDataSheet extends DefaultValueBinder implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithCustomValueBinder, WithEvents, WithHeadings, WithMapping, WithStyles, WithTitle
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event): void {
                ...
                $event->sheet->getDelegate()->getStyle("A1:{$highestColumn}1")->getAlignment()->setWrapText(true);
            },
        ];
    }
